/* Extracted JS from raising-happy-hens.html */
document.addEventListener('DOMContentLoaded', function () {
                            // Handle footer product links
                            document.querySelectorAll('.footer-product-link').forEach(link => {
                                link.addEventListener('click', function (e) {
                                    ...
                                    // If not on products page, normal link behavior will take user to products.html with hash
                                });
                            });

                            // Handle hash on products page load
                            if (window.location.pathname.endsWith('products.html') && window.location.hash) {
